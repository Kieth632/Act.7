<?php
    ...
    echo"<font color='black'> The added value is : ".$_POST['author'].'<br>';
    echo"<font color='black'> The added value is : ".$_POST['quote'].'<br>';
...
<?php 
   if( isset($_POST['Submit']))
   {
        ...
        else
        {
            ...
            echo "<br> <a href='index.php'> Click to show the results! </a>"; 
